...
The next step is to introduce yourself to Git by running a couple of configuration commands. Basically, you need to tell Git who you are, and what your email is. Run the following commands using __your own user name__ and you __own email__.
...
The second part of the lab involves working on a second baby project with Git.
...
The last part of the lab involves setting up your __GitHub Classroom__ repository. Please follow the instructions of the pdf (shown below), available in the `labs/` folder of the course github repo:
