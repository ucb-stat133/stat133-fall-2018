...
- Name this file as `lab06-first-last.R`, where `first` and `last` are your
first and last names (e.g. `lab06-gaston-sanchez.R`).
...
- Visually inspect the contents of the `data/` folder and confirm that the csv files
are there.
...
`weight`, exactly in the same way they are displayed by R (in its console):
