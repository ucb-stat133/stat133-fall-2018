---
title: "Lab 3: Command Line Basics and Data Importing"
...
knitr::opts_chunk$set(echo = TRUE, fig.path = 'lab03-images/')
```
...
The second part of the lab involves importing the __Abalone Data Set__ 
that is part of the
...
basic bash commands to inspect the downloaded data file. Include the commands in your Rmd file inside an unevaluated code chunk.
